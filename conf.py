# -*- coding: utf-8 -*-
#
# pyheapdump documentation build configuration file, created by
...
project = u'pyheapdump'
copyright = u'2014, Anselm Kruis'
...
man_pages = [
    ('index', 'pyheapdump', u'Pyheapdump Documentation',
     [u'Anselm Kruis'], 1)
]
